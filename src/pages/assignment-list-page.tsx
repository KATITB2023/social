  ...
  return (
    <>
      <Flex
        ...
        height="64px"
      >
        <Heading color="#dcdf87">OSKM ITB 2023</Heading>
                ...
                {Object.entries(menuItems).map(([key, value]) =>
                  isPageActive(key) ? (
                    ...
                    <Link
                      ...
                      href={`/${key === "Back to Home" ? "home" : key.toLowerCase()
                        }`}
                      key={key}
                    >
                      <Box
      ...
      >
        ...
        >
          <Box // Box Komet
            ...
            bgPosition="73px -29px"
            bgSize="88px"
            transform="rotate(14.117deg)"
            opacity={0.5}
          />
          <Box // Box Bintang
            width="200px"
